...
from .forms import AddToCartItemForm
import json
...
class CartMixin:
    def get_cart(self, request):
        ...
        if not request.session_session_key:
...
class CartModalView(CartMixin, View):
    def get(self, request):
        ...
        return TemplateResponse(request, 'cart/cart_modal.html', ctx)
...
class AddToCartView(CartMixin, View):
    ...
    def post(self, request, slug):
        ...
        form = AddToCartItemForm(request.POST, product=product)
